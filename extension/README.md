...
1. Open the official extension page: **[Thunder Download Manager on Chrome Web Store](https://chromewebstore.google.com/detail/thunder-download-manager/inhdofocnelidaaldldkpoljakofkbpe)**.
2. Click **"Add to Chrome"** (or **"Get"** / **"Add to Brave/Edge"**) to install with automated background updates.

#### Method 2: Load Unpacked (Development / Manual)
