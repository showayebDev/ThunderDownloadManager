...
// MatchVaultItem checks the in-memory engine config or SQLite kv_store ("download_engine") for matching per-host settings for the given URL.
...
// MatchVaultCredentials checks the in-memory engine config or SQLite kv_store ("download_engine") for matching credentials for the given URL.
