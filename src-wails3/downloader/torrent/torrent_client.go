// Package torrent provides BitTorrent and Magnet link metadata parsing,
// global client management, and download task execution.
package torrent
...
func ParseTorrentInfo(source string) (*TorrentInfo, error) {
	source = core.CleanTorrentSource(source)
	if source == "" {
